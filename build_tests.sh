...
PARSER_FILE="config_parser.cc"
PARSER_HEADER="config_parser.h"
PARSER_TEST_DIR="tests/parser"
PARSER_TEST_FILE="config_parser_test.cc"
BUILD_DIR="build"
...
case `uname` in
  Linux)
    ...
    g++ -std=c++0x -isystem ${GTEST_DIR}/include -pthread ${PARSER_DIR}/${PARSER_FILE} ${PARSER_TEST_DIR}/${PARSER_TEST_FILE} \
